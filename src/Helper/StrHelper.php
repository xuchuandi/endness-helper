...
class StrHelper
{
     ...
     * mb版本 ltrim.
     */
    public static function mb_ltrim(string $str, string $char = ' '): string
    {
        if (empty($str)) {
            return '';
        }
     ...
     * mb版本 rtrim.
     */
    public static function mb_rtrim(string $str, string $char = ' '): string
    {
        if (empty($str)) {
            return '';
        }
     ...
     * mb版本 trim.
     */
    public static function mb_trim(string $str, string $char = ' '): string
    {
        return self::mb_rtrim(self::mb_ltrim($str, $char), $char);
    }
}
